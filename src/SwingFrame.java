...
implements ActionListener{
	...
	private void createMenu(){
		...
		//Dateisystem
		actOpenFile = new AbstractAction("Dateisystem...", new ImageIcon("icons/toolbarButtonGraphics/general/Open24.gif")){
			public void actionPerformed(ActionEvent ae){
		...
		//Web
		actOpenWeb = new AbstractAction("Web...", new ImageIcon("icons/toolbarButtonGraphics/development/Webcomponent24.gif")){
			public void actionPerformed(ActionEvent ae){
